...
public class FishFillet : Item
{
    ...
    public void ReturnToPreviousTarget([Bridge.Ref] Quaternion targetRotation, [Bridge.Ref] Vector3 targetWorldScale)
    {
        ReturnToPreviousTarget(targetRotation, targetWorldScale, false);
    }

    public void ReturnToPreviousTarget(
[Bridge.Ref]         Quaternion targetRotation,
[Bridge.Ref]         Vector3 targetWorldScale,
        bool resumeBob)
    {
    ...
    private Vector3 GetLocalScaleForWorldScale([Bridge.Ref] Vector3 worldScale)
    {
