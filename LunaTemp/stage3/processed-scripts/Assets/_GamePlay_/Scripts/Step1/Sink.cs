...
[Bridge.Ref]         Rect targetRect,
[Bridge.Ref]         Vector3 targetWaterDropPoint,
        float duration,
        Ease ease,
    ...
    private void ApplyWaterDropPosition([Bridge.Ref] Vector3 localPosition)
    {
        CacheWaterDropTransform();
    ...
    private void ApplyWaterRect([Bridge.Ref] Rect rect)
    {
        CacheBasinWaterRenderer();
    ...
    private static Rect LerpRect([Bridge.Ref] Rect from, [Bridge.Ref] Rect to, float progress)
    {
        return new Rect(
    ...
    private static void DrawRectGizmo(Transform reference, [Bridge.Ref] Rect rect, [Bridge.Ref] Color color)
    {
    ...
    private static void DrawPointGizmo(
        Transform reference,
[Bridge.Ref]         Vector3 localPoint,
[Bridge.Ref]         Color color,
        float radius
    )
    {
        Matrix4x4 previousMatrix = Gizmos.matrix;
