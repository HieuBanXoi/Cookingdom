...
public class InWaterItem : Item
{
    ...
    public virtual void OnMoveIntoWaterComplete()
    {
    ...
    protected void SpawnWaterSplashOnEnter(bool wasInWater)
    {
    ...
    protected void ConfigureNextTarget()
    {
    ...
    protected Item GetTargetItem(Transform target)
    {
    ...
    protected void SetPlateFoodShadowActive(bool isActive)
    {
    ...
    public void CanTrashDrag()
    {
            ...
            for (int i = 0; i < trashObj.Length; i++)
        {
            ...
            trashObj[i].gameObject.SetActive(true);
        }
        
    }
    public void CanKnifeCut()
    {
        Debug.Log("CanKnifeCut");
